  ...
  Widget build(BuildContext context) => Center(
        child: Column(
          ...
          children: [
            ...
            TimeBlock(AppLocalizations.of(context)!.six, hoursBeforeSelectedTime(9, 15), ThemeColors.white80),
            const SizedBox(height: 20),
            TimeBlock(AppLocalizations.of(context)!.five, hoursBeforeSelectedTime(7, 45), ThemeColors.white60),
            const SizedBox(height: 20),
            TimeBlock(AppLocalizations.of(context)!.four, hoursBeforeSelectedTime(6, 15), ThemeColors.white40),
            const SizedBox(height: 20),
            TimeBlock(AppLocalizations.of(context)!.three, hoursBeforeSelectedTime(4, 45), ThemeColors.white20),
          ],
        ),
      );
}
